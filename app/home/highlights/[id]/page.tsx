  ...
  // ฟังก์ชันที่ใช้ส่งการแก้ไขคอมเมนต์ไปยัง Backend
  const editComment = async (commentId: string, newMessage: string) => {
    ...
    if (!userId) {
      alert("กรุณาเข้าสู่ระบบก่อนแก้ไขความคิดเห็น");
      return;
    }
    ...
    try {
      ...
      setComments((prevComments) =>
        prevComments.map((comment) =>
          comment.id === commentId ? { ...comment, message: updatedComment.comment } : comment
        )
      );
            ...
            {comments.map((comment) => (
              ...
              >
                ...
                >
                  ...
                  <MenuItem
                    onClick={() => {
                      deleteComment(comment.id); // ใช้ comment.id ในการลบ
